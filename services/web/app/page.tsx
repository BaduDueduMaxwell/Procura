...
import type { AgentResponse, AuthUser, CustomerDashboard as CustomerDashboardData, MedicineCatalogItem, Operations, ReviewBrief, ReviewCase, SupplierDashboard as SupplierDashboardData, SupplierQuoteDraft, SupplierSubmission, Trace } from "@/lib/types";
...
function Reviews() {
  const [cases, setCases] = useState<ReviewCase[]>([]); const [selected, setSelected] = useState<ReviewCase>(); const [brief, setBrief] = useState<ReviewBrief>(); const [briefLoading, setBriefLoading] = useState(false); const [error, setError] = useState(false);
